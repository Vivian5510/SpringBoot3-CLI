package com.rosy.common.constant;
...
public class CommonConstants {
     ...
     */
    public static final String[] JSON_WHITELIST_STR = {"org.springframework", "com.rosy"};

    /**
     * 定时任务白名单配置（仅允许访问的包名，如其他需要可以自行添加）
     */
    public static final String[] JOB_WHITELIST_STR = {"com.rosy.quartz.task"};
